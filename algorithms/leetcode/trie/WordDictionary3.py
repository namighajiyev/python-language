            ...
            for i in range(startIndex, len(word)):
                ...
                if x == "." : 
                    for key in curr:
                        if key == "*":
                            continue
                        if self.searchRecursive(word, curr[key], i+1):
                            return True
                    return False
                else:             
                    if x not in curr:
...
# example 1
dict , res =run(["WordDictionary","addWord","addWord","addWord","search","search","search","search"],
[[],["bad"],["dad"],["mad"],["pad"],["bad"],[".ad"],["b.."]])   
print(isEqual(res, [None,None,None,None,False,True,True,True] ))  

            
## example 2
dict , res =run(["WordDictionary","addWord","addWord","search","search","search","search","search","search"],
[[],["a"],["a"],["."],["a"],["aa"],["a"],[".a"],["a."]])   
